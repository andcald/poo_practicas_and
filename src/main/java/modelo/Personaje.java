...
public class Personaje {
    ...
    public String toString() {
        return "Personaje{" + "nombrePersonaje=" + nombrePersonaje + ", nombreActor=" + nombreActor + ", codigo=" + codigo + ", papel=" + papel + ", fechaNacimientoA=" + fechaNacimientoA + ", pelicula=" + pelicula + "\n";
    }
