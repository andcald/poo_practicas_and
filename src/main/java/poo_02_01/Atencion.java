...
public class Atencion {
    ...
    public Atencion(LocalDate fecha, String veterinario, int cantidadRecetas, Dueño owner, Mascota mascota) {
        this.fecha = fecha;
    ...
    public String toString() {
        ...
        System.out.println("La cantidad de recetas es: "+ cantidadRecetas);        
